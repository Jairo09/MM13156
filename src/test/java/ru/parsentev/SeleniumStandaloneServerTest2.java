...
public class SeleniumStandaloneServerTest2 {
    ...
    private void PruebaDos(final WebDriver driver) throws MalformedURLException {
        ...
        nombre.sendKeys("monge@gmail.com");
        driver.findElement(By.id("password")).sendKeys("mongemojica");
    ...
    private void PruebaTres(WebDriver driver) throws MalformedURLException {
        ...
        WebElement btnRegister = driver.findElement(By.name("todosCursos"));
        btnRegister.click();
       try {
         Thread.sleep(2000);
       
       }catch (InterruptedException ex) {
              Logger.getLogger(SeleniumStandaloneServerTest2.class.getName()).log(Level.SEVERE, null, ex);
       }
    }
    ...
    private void PruebaOcho(WebDriver driver) throws MalformedURLException {
        ...
        WebElement buscar = driver.findElement(By.name("buscarTodosCurso"));
        buscar.sendKeys("Física III");
       try {
         Thread.sleep(2000);
    ...
    private void PruebaNueve(WebDriver driver) throws MalformedURLException {
        ...
        WebElement btnEditar = driver.findElement(By.name("entrarCurso"));
        btnEditar.click();
       /*
     ...
     private void PruebaDiez(WebDriver driver) throws MalformedURLException {
        ...
        WebElement btnEliminar = driver.findElement(By.name("entrarPublicacion"));
        btnEliminar.click();
